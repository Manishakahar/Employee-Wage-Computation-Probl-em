...
public class EmployeeWage {
    ...
    public static int EmployeeWage(String company, int EMP_WAGE_PER_HR, int NUM_MAX_WORKING_WORKING_DAYS, int MAX_HRS_IN_MONTH) {
    ...
    public static void main(String[] args) {
        ...
        EmployeeWage(" DMart " + 20, 20, 20, 100);
        EmployeeWage("Reliance " + 10, 10, 20, 100);
    }
}
